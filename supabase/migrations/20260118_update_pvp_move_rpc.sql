-- Updated PvP Move Validation RPC with Type Effectiveness and Turn Management
...
-- Determine defender type (highest stat)
-- Stats are influence, chaos, charisma, rebellion
...
END IF;
-- Type Matchup Logic
-- CHAOS → INTEL → DISRUPT → CHARISMA → REBELLION → CHAOS
