                    ...
                    >
                        ...
                        <div className="p-6 pb-4 border-b border-white/5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 bg-white/5 border border-white/10 text-white text-xs font-mono rounded-sm focus:outline-none focus:border-neon-blue/50 placeholder:text-white/20 mb-3"
                            />
