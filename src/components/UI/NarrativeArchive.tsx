        ...
        <AnimatePresence mode="wait">
            ...
            >
                <div
                    ...
                    className="relative w-full max-w-6xl h-full max-h-[800px] bg-resistance-dark border-2 border-neon-blue/20 shadow-[0_0_50px_rgba(0,243,255,0.15)] flex flex-col md:flex-row overflow-hidden rounded-sm"
                    tabIndex={-1}
                >
                    ...
                    <div className="w-full md:w-80 border-b md:border-b-0 md:border-r border-white/10 flex flex-col bg-black/40 relative z-10">
                        <div className="p-6 border-b border-white/10">
                            <h3 id="archive-title" className="text-xl font-black neon-text-blue italic uppercase tracking-tighter flex items-center gap-2">
                            ...
                            {starter5.map((s) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isUnlocked && <ChevronRight size={14} className="opacity-40" aria-hidden="true" />}
                                    </button>
                                );
                            })}
                        </div>
                        ...
                        >
                            <X size={14} aria-hidden="true" /> Close_Archives
                        </button>
                    </div>

                    {/* Main Content: Story Detail */}
                    <div className="flex-1 overflow-y-auto relative z-10 bg-gradient-to-b from-transparent to-black/20" role="region" aria-label="Narrative content">
                        {selectedStreamer ? (
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="p-3 bg-white/5 border border-white/5">
                                                <div className="text-[8px] text-white/40 uppercase mb-1 flex items-center gap-2 font-black">
                                                    <Target size={10} className="text-neon-pink" aria-hidden="true" /> Strategic_Role
                                                </div>
                                                <div className="text-xs font-bold text-white tracking-widest">{selectedStreamer.narrative.role}</div>
                                            </div>
                                            <div className="p-3 bg-white/5 border border-white/5">
                                                <div className="text-[8px] text-white/40 uppercase mb-1 flex items-center gap-2 font-black">
                                                    <Zap size={10} className="text-neon-yellow" aria-hidden="true" /> Combat_Trait
                                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 border-t border-white/10 pt-10">
                                    <section>
                                        <h4 className="text-[10px] font-black tracking-[0.4em] text-neon-blue uppercase mb-6 flex items-center gap-3">
                                            <div className="w-4 h-[2px] bg-neon-blue" aria-hidden="true" />
                                            Origin_Story
                                        </h4>
                                    ...
                                    <section>
                                        <h4 className="text-[10px] font-black tracking-[0.4em] text-resistance-accent uppercase mb-6 flex items-center gap-3">
                                            <div className="w-4 h-[2px] bg-resistance-accent" aria-hidden="true" />
                                            Active_Mission
                                        </h4>
                            ...
                            <div className="h-full flex flex-col items-center justify-center text-center p-12 opacity-30">
                                <div className="w-20 h-20 border-2 border-neon-blue flex items-center justify-center mb-6 rotate-45">
                                    <User size={32} className="-rotate-45" aria-hidden="true" />
                                </div>
